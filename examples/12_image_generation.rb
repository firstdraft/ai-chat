...
puts "User: #{c.user("Transform this image into Studio Ghibli animation style - with soft colors, warm lighting, hand-drawn outlines, and the dreamy atmosphere of a Ghibli film", image: image_path)}"
c.generate!
